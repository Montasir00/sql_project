<?php
// This file is for giving queries to MySQL to perform operations on the database.
// The queries are written in the $sql variable.
require_once('config.php');
$sql = "-- Below are the queries used to create the database and its tables in MySQL:
...
if (mysqli_query($con, $sql)) {
    ...
    echo "Erro running query " . mysqli_error($con);
}
